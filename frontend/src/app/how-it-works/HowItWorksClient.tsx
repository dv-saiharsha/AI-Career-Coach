      ...
      <section className="relative overflow-hidden pt-36 pb-16 px-4">
        ...
        >
          ...
          <p className="text-[var(--color-ink-dim)] text-lg max-w-2xl mx-auto leading-relaxed">
            AI Career Coach runs a complete, automated 12-step pipeline that transforms your resume into a fully optimized application and your preparation into a competitive advantage.
          </p>
        </motion.div>
      </section>
