...
export function DashboardMock() {
  return (
    <div className="relative mx-auto w-full max-w-4xl">
      ...
      {/* ── The window ────────────────────────────────────────────────── */}
      <div className="overflow-hidden rounded-3xl bg-canvas-raise elev-lg">
        {/* Chrome. The dots are inset, like every other pressed thing. */}
        <div className="flex items-center gap-2 px-6 py-4">
          {[0, 1, 2].map((i) => (
            <span key={i} className="size-2.5 rounded-full bg-canvas field-ring-soft" aria-hidden="true" />
          ))}
        ...
        <div className="flex flex-col gap-5 px-5 pb-6 sm:px-6 sm:pb-7">
            ...
            {TILES.map((tile) => (
              <div
                ...
                className={
                  ...
                  (tile.accent ? 'elev-accent' : 'bg-canvas-raise elev-md')
                }
              >
          ...
          <div className="rounded-2xl bg-canvas p-5 field-ring">
