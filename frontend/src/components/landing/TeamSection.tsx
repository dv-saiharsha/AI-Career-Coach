...
const TEAM: {
...
}[] = [
  {
    ...
    blurb: 'The original idea behind ApplyCenter. Designs and builds every pixel of the UI and frontend.',
    bio: "ApplyCenter started as Venkata Sai's idea — the whole product, from the particle hero to the resume diagnostics, was designed and built by him. He owns the entire frontend: every screen, animation, and interaction in the app.",
  ...
  },
  {
    ...
    bio: 'Varma owns the backend end-to-end — the API layer, business logic, and everything related to how ApplyCenter stores and serves data, from resume analyses to interview history.',
  ...
  },
  {
    name: 'Shiva Valluri',
    role: 'Marketing Lead',
    blurb: 'Drives growth, positioning, and marketing for ApplyCenter.',
    bio: 'Shiva drives how the world finds out about ApplyCenter — positioning, growth strategy, content, and everything marketing-related for the product.',
